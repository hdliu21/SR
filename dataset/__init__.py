...
class DATASET:
    ...
    DIV2K = edict()
    DIV2K.TRAIN = edict()
    DIV2K.TRAIN.HRx2 = '/data/hdliu/dataset/DIV2K/DIV2K_train_HR_sub'  # 32208
    ...
    DIV2K.TRAIN.LRx2 = '/data/hdliu/dataset/DIV2K/DIV2K_train_LR_bicubic/X2_sub'
    ...
    Flickr2K.TRAIN.HRx2 = '/data/hdliu/dataset/Flickr2K/Flickr2K_HR_sub'  # 106641
    ...
    Flickr2K.TRAIN.LRx2 = '/data/hdliu/dataset/Flickr2K/Flickr2K_LR_bicubic/X2_sub'
    ...
    Set14 = edict()
    Set14.VAL = edict()
    Set14.VAL.HRx2 = '/data/hdliu/dataset/Set14/HR/modX2'
    Set14.VAL.HRx3 = None
    Set14.VAL.HRx4 = None
    Set14.VAL.LRx2 = '/data/hdliu/dataset/Set14/LR_bicubic/X2'
    Set14.VAL.LRx3 = None
    Set14.VAL.LRx4 = None

    BSDS100 = edict()
    BSDS100.VAL = edict()
    BSDS100.VAL.HRx2 = '/data/hdliu/dataset/BSDS100/HR/modX2'
    ...
    BSDS100.VAL.LRx2 = '/data/hdliu/dataset/BSDS100/LR_bicubic/X2'
